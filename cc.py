...
class CCVisitor(ASTVisitor):
    ...
    def visitFunction(self, node):
        ...
        self.thing("def", "Function Stats", stats)
        self.stats.functions.append(stats)

    visitLambda = visitFunction

    def thing(self, tp, name, stats):
        #print "~~~~~%s~~~~~" % name
        #print "=> %s Name: %s" % (tp, stats.name)
        #print "=> Classes: %s" % stats.classes
        #print "=> Complexity: %s" % stats.complexity
        
        #for function_stats in stats.functions:
        #    self.thing('method for %s' % stats.name, 'Method Stats', function_stats)
    ...
    def visitClass(self, node):
        ...
        stats = CCVisitor(node, stats).stats
        self.thing("class", "Class Stats", stats)
